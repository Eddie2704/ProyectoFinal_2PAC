                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        icon: isPassWordVisible ? const Icon(
                          Icons.visibility, color: Colors.white): const Icon(Icons.visibility_off,color: Colors.white,)),
                    ...
                    SizedBox(
                      ...
                      onPressed: (){
                        ...
                        context.goNamed("home"),
                         */       
                        if(!correo.endsWith("@gmail.com") || !correo.endsWith("@icloud.com")){
                          showDialog(
                            context: context, 
                            builder: (context){
                              return AlertDialog(
